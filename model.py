...
#load data
df = pd.read_csv(r"C:\Users\hardi\OneDrive\Desktop\Hardik stuff\SEM 5\SEM 5\Actual_mini_project\Banglore House Price Prediction\data\ohe_data_reduce_cat_class.csv")
...
model = joblib.load(r'C:\Users\hardi\OneDrive\Desktop\Hardik stuff\SEM 5\SEM 5\Actual_mini_project\Banglore House Price Prediction\bangalore_house_price_prediction_rfr_model.pkl')
